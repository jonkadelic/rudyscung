...
#define CANTOR(a, b) ((((a + b) * (a + b + 1)) >> 1) + b)
...
#define VEC_MUL_INIT(a, b) { a[AXIS__X] * b[AXIS__X], a[AXIS__Y] * b[AXIS__Y], a[AXIS__Z] * b[AXIS__Z] }
#define VEC_MUL(a, b) ((typeof(a[0])[]) VEC_MUL_INIT(a, b))
